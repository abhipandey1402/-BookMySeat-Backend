...
import com.example.BookMySeatBackend.Converter.TheaterConverter;
import com.example.BookMySeatBackend.Enum.SeatType;
import com.example.BookMySeatBackend.Model.TheaterEntity;
import com.example.BookMySeatBackend.Model.TheaterSeatEntity;
import com.example.BookMySeatBackend.Repository.TheaterRepository;
import com.example.BookMySeatBackend.Repository.TheaterSeatRepository;
...
//        seats.add(theaterSeat10);
    ...
    public List<TheaterResponseDto> getTheaterList() {
        ...
        List<TheaterResponseDto> theaterList = TheaterConverter.converEntityListToDto(theaterEntityList);
